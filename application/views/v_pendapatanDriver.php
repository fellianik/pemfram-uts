...
<form action="<?php echo base_url() ?>index.php/pendapatanDriver/filter" method="post">
    <div class="mb-3">
    ...
    <a type="button" class="btn btn-danger mb-3" href="<?php echo base_url('index.php/pendapatan/driver') ?>">Reset</a>
</form>
